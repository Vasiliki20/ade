						...
						<div class="row">
							<div class="column">
								<div style="width: 50%; float:left">
									...
									3
									<br>
									<label for="q34">34. Άγχος/ανησυχία:</label>
								...
								<div style="width: 50%; float:right">
									<label for="q35">35. Ένταση/πίεση:</label>
									...
									3
									<br>
									<label for="q36">36. Φοβίες για συγκεκριμένα μέρη ή πράγματα:</label>
									...
									3
									<br>
									<label for="q37">37. Έμμονες σκέψεις:</label>
									...
									3
									<br>
									<label for="q38">38. Επίμονες επαναλαμβανόμενες συμπεριφορές:</label>
									...
									3
									<br>
									<label for="q39">39. Προβήματα διατροφής:</label>
									...
									3
									<br>
									<label for="q40">40. Προβλήματα με βάρος:</label>
									...
									3
									<br>
									<label for="q41">41. Αλλαγές στην όρεξη για φαγητό:</label>
									...
									3
									<br>
									<label for="q42">42. Προβλήματα υγείας:</label>
									...
									3
									<br>
									<label for="q43">43. Σωματική Αναπηρίας:</label>
									...
									3
									<br>
									<label for="q44">44. Εγκεφαλικό τραύμα:</label>
									...
									3
									<br>
									<label for="q45">45. Τραυματικό γεγονός:</label>
									...
									3
									<br>
									<label for="q46">46. Υπερκινητικότητα:</label>
									...
									3
									<br>
									<label for="q47">47. Παρορμητική συμπεριφορά:</label>
									...
									3
									<br>
									<label for="q48">48. Προβλήματα με αλκοόλ:</label>
									...
									3
									<br>
									<label for="q49">49. Προβλήματα με άλλες ουσίες:</label>
									...
									3
									<br>
									<label for="q50">50. Προβλήματα με τζόγο:</label>
									...
									3
									<br>
									<label for="q51">51. Ενασχόληση διαδικτυακά παιγνίδια:</label>
									...
									3
									<br>
									<label for="q52">52. Διαχείριση χρόνου:</label>
									...
									3
									<br>
									<label for="q53">53. Κακοποίηση(σωματική, σεξουαλική, λεκτική, παραμέληση):</label>
									...
									3
									<br>
									<label for="q54">54. Ακούω φωνές:</label>
									...
									3
									<br>
									<label for="q55">55. Πιστεύω ότι με παρακολουθούν:</label>
									...
									3
									<br>
									<label for="q56">56. Πιστεύω ότι με ελέγχουν/χειραγωγούν:</label>
									...
									3
									<br>
									<label for="q57">57. Αλλόκοτη συμπεριφορά:</label>
									...
									3
									<br>
									<label for="q58">58. Οικονομικά προβλήματα:</label>
									...
									3
									<br>
									<label for="q59">59. Νομικά προβλήματα:</label>
									...
									3
									<br>
									<label for="q60">60. Σκέψεις αυτοκτονίας:</label>
									...
									3
									<br>
									<label for="q61">61. Σκέψεις ανθρωποκτονίας:</label>
									...
									3
									<br>
									<label for="q64">63. Άλλο</label>
									<input type="text" class="form-control" id="q64" name="q64">
									<input type="hidden" name="q65">
