						...
						<div class="panel-body">
							...
							<div class="form-group">
									...
									<?php for($m=0;$m<count($response['anaskopisi']);$m++){ ?>
									 <li><a href="form11see.php?an=<?=Encryption::encode($m)?>&patientID=<?=Encryption::encode($_GET['patientID'])?>">Ανασκόπηση <?=$m?></a></li>
									<?php     }  ?> 
									</ul>
								</div>
							<div class="form-group">
...
if(isset($_POST['addmore'])){
	header("Location:form11.php?patientID=".Encryption::encode($_GET['patientID']));
