				...
				<div class="container">
					...
					<form action="/action_page.php">
						<div class="row">
							...
							<div class="form-group">
								<label for="q23"><strong>23. Περιγράψτε επίσης λίγο πιο αναλυτικά τα στοιχεία στις υπηρεσίες που λάβατε, τα οποία βρήκατε λιγότερο βοηθητικά ή αρνητικά. </strong> <br> <em>(συμπεριλάβετε οποιοδήποτε περιστατικό σας φάνηκε αρνητικό ή δύσκολο). </em>:</label>
